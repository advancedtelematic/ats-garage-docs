...
----
sudo ../flash-configured-image.sh ./tmp/deploy/images/raspberrypi3/core-image-minimal-raspberrypi3.rpi-sdimg-ota /path/to/your/sota_client.toml /dev/sdX
----
<1> Make sure the path to your sota_client.toml file and the correct block device for your micro SD card substituted in.
