...
polling_sec = 60 <2>
----
<1> Boolean indicating whether ATS Garage should be polled for new updates. In general, you would want to leave this on, but if you have another service that's triggering update checks using the link:../cli-dev/client-commands-and-events-reference.html#commands[GetUpdateRequests command], you might want to disable update polling.
