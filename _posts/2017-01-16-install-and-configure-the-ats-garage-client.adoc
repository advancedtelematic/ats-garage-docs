...
If you are planning to use a custom software installer with ATS Garage, you'll need to complete some manual steps that are taken care of automatically in the OSTree or package-based getting started guides. You'll need to:
