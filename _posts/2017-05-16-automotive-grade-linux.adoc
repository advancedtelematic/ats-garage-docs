...
First, clone a manifest file for AGL masterfootnote:[AGL Master should generally be working and buildable at all times, and has a more up-to-date meta-updater revision than the Chinook or Dab point releases.]:
