...
****
We'd love to hear from you about how we can improve the docs and make {product-name} better. Contact link:mailto:ota-support@here.com[ota-support@here.com] and we'll do our best to help.
****
