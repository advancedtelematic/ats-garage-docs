...
----
+
For example, to deploy an image called `new-feature` with SHA `001ee11a28e3e08f3e93e31425f0721a7fb44946919284b629ca85a1cc3073cb` and make it installable on all Raspberry Pi devices on your target account, the command would be:
+
----
garage-deploy --commit 001ee11a28e3e08f3e93e31425f0721a7fb44946919284b629ca85a1cc3073cb \
  --name new-feature -f source-credentials.zip -t dest-credentials.zip -h raspberrypi3
----
+
